...
public class UnlockedVideosFragment extends Fragment {

    public UnlockedVideosFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_unlocked_videos, container, false);
    }
    @Override
